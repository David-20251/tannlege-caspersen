...
const Index = () => {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <Section>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {features.map((f, i) => (
                <div key={f.title} className="glass-card rounded-xl p-7 hover:border-primary/20 transition-all duration-300 group" style={{ animationDelay: `${i * 100}ms` }}>
      ...
      {/* What we help with — includes OCT image */}
      <section className="py-20 md:py-28 bg-card/50">
        <div className="max-w-4xl mx-auto px-6">
          <Section>
            ...
            {/* OCT highlight card */}
            <div className="glass-card rounded-2xl overflow-hidden mb-8 hover:border-primary/20 transition-all duration-300 group">
              <div className="grid md:grid-cols-2 gap-0">
                <div className="overflow-hidden">
                  <img
                    src={octScan}
                    alt="OCT-A netthinneundersøkelse – avansert skanning av netthinnen"
                    className="w-full h-full min-h-[220px] object-cover group-hover:scale-[1.02] transition-transform duration-700"
                    loading="lazy"
                  />
                </div>
          ...
          <Section>
            <div className="glass-card rounded-2xl p-8 md:p-12 glow-accent">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">Fyll inn skjemaet, så tar vi kontakt med deg for å avtale en time.</p>
              </div>
              <BookingForm />
            </div>
          </Section>
          ...
          <Section>
            <div className="grid sm:grid-cols-3 gap-8 text-center">
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <a href="https://maps.google.com/?q=59.987272,11.246747" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
